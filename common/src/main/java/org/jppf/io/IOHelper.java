...
public final class IOHelper {
   ...
   */
  private static ObjectSerializer DEFAULT_SERIALIZER = new ObjectSerializerImpl();
  ...
  /**
   * Create a new instance of the default serializer.
   */
  public static void resetDefaultSerializer() {
    DEFAULT_SERIALIZER = new ObjectSerializerImpl();
  }
}
