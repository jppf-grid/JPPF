...
/**
 * A sorted map whose values are {@code ArrayList}s of a given component type.
 * @param <K> the type of keys in the map.
 * @param <V> the type of values in the collections mapped to the keys.
 * @author Laurent Cohen
 */
public class ArrayListSortedMap<K, V> extends AbstractCollectionSortedMap<K, V> {
  /**
   ...
   */
  public ArrayListSortedMap(final Comparator<K> comparator) {
    super(comparator);
  }
