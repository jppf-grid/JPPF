...
public class HookInstance<E> {
   ...
   */
  private static final Logger log = LoggerFactory.getLogger(HookInstance.class);
  /**
  ...
  public Object invoke(final String methodName, final Object... parameters) {
    ...
    try {
      ...
      final String format = "failed to invoke '{}()' with params={} on {} with exception={}";
      final Object[] params = new Object[] { methodName, nbArgs == 0 ? "{}" : Arrays.asList(parameters), this, debugEnabled ? ExceptionUtils.getStackTrace(e) : ExceptionUtils.getMessage(e) };
