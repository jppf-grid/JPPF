...
/**
 * Performs a comparison of type "at least lower_bound and at most upper_bound" between a {@code Comparable} metadata value or a job name
 * and {@code Comparable} lower and upper bounds.
 * @author Laurent Cohen
 * @since 6.2
 */
public class BetweenIIJobSelector extends AbstractTernaryComparisonJobSelector<Comparable<?>> {
  /**
   ...
   */
  public BetweenIIJobSelector(final String lower, final String upper) {
   ...
   */
  public BetweenIIJobSelector(final Object key, final Comparable<?> lower, final Comparable<?> upper) {
