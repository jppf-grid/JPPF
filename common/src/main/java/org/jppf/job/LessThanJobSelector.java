...
/**
 * Performs a "less than" strict comparison between a job metadata value or a job name and an other comparable value.
 * @author Laurent Cohen
 * @since 6.2
 */
public class LessThanJobSelector extends AbstractBinaryComparisonJobSelector<Comparable<?>> {
  /**
   ...
   */
  public LessThanJobSelector(final String operand) {
    this(null, operand);
  }
   ...
   * @param operand the operand to compare with.
   */
  public LessThanJobSelector(final Object key, final Comparable<?> operand) {
    super(key, operand);
  }
