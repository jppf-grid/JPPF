...
abstract class AbstractBinaryComparisonJobSelector<E> implements JobSelector {
  ...
  public boolean equals(final Object obj) {
    ...
    if (!(obj instanceof AbstractBinaryComparisonJobSelector)) return false;
    final AbstractBinaryComparisonJobSelector<?> other = (AbstractBinaryComparisonJobSelector<?>) obj;
    if (key == null) {
