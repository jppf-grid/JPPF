...
/**
 * Performs a comparison of type "at least lower_bound and strictly less than upper_bound" between a {@code Comparable} metadata value or a job name
 * and {@code Comparable} lower and upper bounds.
 * @author Laurent Cohen
 * @since 6.2
 */
public class BetweenIEJobSelector extends AbstractTernaryComparisonJobSelector<Comparable<?>> {
  /**
   ...
   */
  public BetweenIEJobSelector(final String lower, final String upper) {
   ...
   */
  public BetweenIEJobSelector(final Object key, final Comparable<?> lower, final Comparable<?> upper) {
