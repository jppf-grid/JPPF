...
public class JPPFSuspendedNodeException extends RuntimeException {
   ...
   */
  public JPPFSuspendedNodeException(final String message, final Throwable cause) {
    super(message, cause);
  }
   ...
   * @param message the message for this exception.
   */
  public JPPFSuspendedNodeException(final String message) {
    super(message);
  }
   ...
   * @param cause the cause exception.
   */
  public JPPFSuspendedNodeException(final Throwable cause) {
    super(cause);
  }
}
