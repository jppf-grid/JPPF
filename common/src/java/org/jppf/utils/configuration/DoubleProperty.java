...
public class DoubleProperty extends NumberProperty<Double> {
   ...
   */
  public DoubleProperty(final String name, final Double defaultValue, final String...aliases) {
   ...
   */
  public DoubleProperty(final String name, final Double defaultValue, final Double minValue, final Double maxValue, final String... aliases) {
