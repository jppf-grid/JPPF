...
public abstract class AbstractJPPFProperty<T> implements JPPFProperty<T> {
  ...
  @Override
  public String getDocumentation(final Locale locale) {
    return LocalizationUtils.getLocalized(i18nBase, name + ".doc", locale);
  }
  ...
  public String getShortLabel(final Locale locale) {
    return LocalizationUtils.getLocalized(i18nBase, name, locale);
  }
