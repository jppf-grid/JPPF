 ...
 */
public class MoreThan extends BinaryNumericRule {
  /**
   ...
   */
  public MoreThan(final String propertyNameOrExpression, final double a) {
   ...
   * @param a the value to compare with.
   */
  public MoreThan(final String propertyNameOrExpression, final String a) {
    super(propertyNameOrExpression, a);
  }
