 ...
 */
public class AtMost extends BinaryNumericRule {
  /**
   ...
   */
  public AtMost(final String propertyNameOrExpression, final double a) {
   ...
   */
  public AtMost(final String propertyNameOrExpression, final String a) {
    super(propertyNameOrExpression, a);
  }
