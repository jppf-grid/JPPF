 ...
 */
public class AcceptorAcceptTask implements Runnable {
  /**
   * Logger for this class.
   */
  private static Logger log = LoggerFactory.getLogger(AcceptorAcceptTask.class);
  /**
   ...
   */
  public AcceptorAcceptTask(final NioServer<?, ?> server, final ServerSocketChannel serverSocketChannel, final SocketChannel channel, final boolean ssl) {
    this.server = server;
