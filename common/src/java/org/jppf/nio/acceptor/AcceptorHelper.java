 ...
 */
public class AcceptorHelper {
  /**
   * 
   */
  private static Map<Integer, NioServer<?, ?>> identifiedServers = Collections.synchronizedMap(new HashMap<Integer, NioServer<?, ?>>());
   ...
   */
  public static NioServer<?, ?> getServer(final int identifier) {
