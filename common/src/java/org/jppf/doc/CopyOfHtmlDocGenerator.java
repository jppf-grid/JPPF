 ...
 */
public class CopyOfHtmlDocGenerator
{
	/**
	...
	public static void main(String...args)
	{
		try
		{
			...
			CopyOfHtmlDocGenerator docGen = new CopyOfHtmlDocGenerator();
	...
	private static void showUsageAndExit(String msg)
	{
		...
		System.err.println("HtmlDocGenerator usage: java "+CopyOfHtmlDocGenerator.class.getName()+" sourceDir"+" targetDir"+" templatesDir");
		System.err.println();
