 ...
 */
public class CopyOfRLProfile extends AbstractAutoTuneProfile
{
	/**
	 * A default profile with default parameter values.
	 */
	private static AtomicReference<CopyOfRLProfile> defaultProfile = new AtomicReference<CopyOfRLProfile>(new CopyOfRLProfile());
	/**
	 ...
	 */
	public CopyOfRLProfile(String profileName)
	{
	...
	{
		CopyOfRLProfile other = new CopyOfRLProfile();
	 ...
	 */
	public static CopyOfRLProfile getDefaultProfile()
	{
