...
/**
 * Performs a comparison of type "strictly more than lower_bound and at most upper_bound" between a {@code Comparable} metadata value or a job name
 * and {@code Comparable} lower and upper bounds.
 * @author Laurent Cohen
 * @since 6.2
 */
public class BetweenEIJobSelector extends AbstractTernaryComparisonJobSelector<Comparable<?>> {
  /**
  ...
  /**
   * Initialize this job selector with lower and upper bounds.
   * @param lower the lower bound to compare job names with.
   * @param upper the upper bound to compare job names with.
   */
  public BetweenEIJobSelector(final String lower, final String upper) {
   ...
   */
  public BetweenEIJobSelector(final Object key, final Comparable<?> lower, final Comparable<?> upper) {
