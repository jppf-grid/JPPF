...
/**
 * Performs a "more than" strict comparison between a job metadata value or a job name and an other comparable value.
...
public class MoreThanJobSelector extends AbstractBinaryComparisonJobSelector<Comparable<?>> {
   ...
   */
  public MoreThanJobSelector(final String operand) {
    this(null, operand);
  }
   ...
   * @param operand the operand to compare with.
   */
  public MoreThanJobSelector(final Object key, final Comparable<?> operand) {
    super(key, operand);
  }
