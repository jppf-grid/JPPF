...
/**
 * Performs a "at least" comparison between a job metadata value or job name and an other comparable value.
 * @author Laurent Cohen
 * @since 6.2
 */
public class AtLeastJobSelector extends AbstractBinaryComparisonJobSelector<Comparable<?>> {
  /**
   ...
   * @param operand the operand to compare job names with.
   */
  public AtLeastJobSelector(final String operand) {
    this(null, operand);
  }
   ...
   */
  public AtLeastJobSelector(final Object key, final Comparable<?> operand) {
    super(key, operand);
  }
