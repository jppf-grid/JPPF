 ...
 */
public class JPPFTimeoutException extends RuntimeException {
  /**
   ...
   */
  public JPPFTimeoutException(final String message, final Throwable cause) {
    super(message, cause);
  }
   ...
   * @param message the message for this exception.
   */
  public JPPFTimeoutException(final String message) {
    super(message);
  }
   ...
   * @param cause the cause exception.
   */
  public JPPFTimeoutException(final Throwable cause) {
    super(cause);
  }
}
