@echo off
set JAVA_ARGS=-cp config;lib/* -Xmx256m -Dlog4j.configuration=log4j-gui.properties -Djppf.config=jppf-gui.properties org.jppf.ui.monitoring.UILauncher org/jppf/ui/options/xml/JPPFAdminTool.xml file
