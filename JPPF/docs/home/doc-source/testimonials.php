<html>
	$template{name="head-section" title="User Testimonials"}$

	<body>
		<div align="center">
		$template{name="jppf-header"}$
		<h1 align="center" style="color: blue">User Testimonials</h1>
		<table cellspacing="0" cellpadding="0" width="80%">
			<tr><td colspan="*"><br>
			$template{name="highlight-header" span="1" title="<a href='http://www.sandia.gov/' style='color: yellow; text-decoration: none'>Sandia National Laboratories</a>"}$
