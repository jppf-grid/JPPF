...
<pre class="samples"><font color="green"># the size of the matrices to multiply</font>
matrix.size = 300
<font color="green"># number of times the matrix multiplication is performed</font>
matrix.iterations = 100</pre>
						</li>
