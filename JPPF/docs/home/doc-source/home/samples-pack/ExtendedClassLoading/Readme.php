...
<div align="justify">
          ...
          The node behavior is driven by an <a href="http://www.jppf.org/doc/v4/index.php?title=Receiving_notifications_of_node_life_cycle_events#Extended_notifications:_the_NodeLifeCycleListenerEx_interface">extended node life cycle listener</a>:
          <ul class="samplesList">
          	...
          	<li>On "job header loaded" events, the node reads the metadata associated with the jobs and performs repository updates accordingly:
						<ol class="samplesList">
							...
							The <a href="http://www.jppf.org/api/org/jppf/node/event/NodeLifeCycleListenerEx.html#jobHeaderLoaded(org.jppf.node.event.NodeLifeCycleEvent)">NodeLifeCycleListenerEx.jobHeaderLoaded()</a> method
