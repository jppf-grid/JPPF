...
<div align="justify">
          ...
          <ul class="samplesList">
            <li>you will first need to start a JPPF server and one node. For information on how to set up a node and server, please refer to the <a href="http://www.jppf.org/doc/v4/index.php?title=Introduction">JPPF documentation</a>.</li>
            <li>start a JPPF administration console</li>
            <li>once you can see the driver and node in the console's topology view, select the node, then click on the "<a href="http://www.jppf.org/doc/v4/index.php?title=Node_provisioning#Provisioning_with_the_administration_console">node provisioning"</a>
          ...
          <ul class="samplesList">
            ...
            <li><a href="src/org/jppf/example/concurrentjobs/MyTask.java.html">MyTask.java</a>: a simmple JPPF task implementation used by all execution patterns in the demo</li>
          </ul>
