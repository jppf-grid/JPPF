...
<div align="justify" class="blockWithHighlightedTitle" style="padding: 5px">
					...
					<ol class="samplesList">
						...
						<li>When the connection fails, the <a href="http://www.jppf.org/doc/v5/index.php?title=Node_configuration#Recovery_and_failover">recovery mechanism</a> will attempt to reconnect to the current server</li>
...
Node successfully initialized</pre>
            ...
            <li><a href="config/node/jppf-node.properties.html">node/jppf-node.properties</a> : the configuration of the node</li>
					...
					<a href="http://www.jppf.org/doc/v5/index.php?title=Node_initialization_hooks">Node Initialization Hooks</a> section.
