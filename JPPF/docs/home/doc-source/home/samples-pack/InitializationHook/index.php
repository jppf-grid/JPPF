...
<ol class="samplesList">
  ...
  <li>When the connection fails, the <a href="http://www.jppf.org/doc/5.2/index.php?title=Node_configuration#Recovery_and_failover">recovery mechanism</a> will attempt to reconnect to the current server</li>
...
<a href="http://www.jppf.org/doc/5.2/index.php?title=Node_initialization_hooks">Node Initialization Hooks</a> section.
