...
<ul class="samplesList">
  ...
  <li>for full details, please take a look at the <a href="src/main/java/org/jppf/example/loadbalancer/client/CustomLoadBalancerRunner.java.html">fully commented job runner source code</a></li>
</ul>
...
<ul class="samplesList">
  ...
  <li>for full details, please take a look at the <a href="src/main/java/org/jppf/example/loadbalancer/server/CustomLoadBalancer.java.html">fully commented load-balancer source code</a></li>
</ul>
...
<ul>
  <li><a href="target/tohtml/src/org/jppf/example/loadbalancer/server/CustomLoadBalancer.java.html">CustomLoadBalancer</a>: load-balancer implementation</li>
  <li><a href="target/tohtml/src/org/jppf/example/loadbalancer/server/CustomLoadBalancerProvider.java.html">CustomLoadBalancerProvider</a>: the provider class that plugs our load balancer into the JPPF server</li>
  <li><a href="target/tohtml/src/org/jppf/example/loadbalancer/client/CustomLoadBalancerRunner.java.html">CustomLoadBalancerRunner</a>: the client side application that executes the jobs on the grid</li>
  <li><a href="target/tohtml/src/org/jppf/example/loadbalancer/client/CustomLoadBalancerTask.java.html">CustomLoadBalancerTask</a>: the JPPF tasks enclosed in the jobs</li>
  <li><a href="target/tohtml/src/org/jppf/example/loadbalancer/common/MyCustomPolicy.java.html">MyCustomPolicy</a>: the custom execution policy used for "heavy" jobs</li>
</ul>
