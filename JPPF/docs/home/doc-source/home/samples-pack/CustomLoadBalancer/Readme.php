...
This samples illustrates the implementation of a custom load-balancer that uses information about the nodes and the submitted jobs, to dispatch JPPF tasks to the nodes.
...
<pre style="background: #D8D8D8">[java] ********** Results for job : Heavy Job **********
[java]
...
<ul>
	<li><a href="http://www.jppf.org/wiki/index.php?title=Extending_and_Customizing_JPPF#Creating_a_custom_load-balancer">Creating a custom load-balancer</a></li>
	<li><a href="http://www.jppf.org/wiki/index.php?title=Extending_and_Customizing_JPPF#Node-aware_load_balancers">Node-aware load-balancers</a></li>
	<li><a href="http://www.jppf.org/wiki/index.php?title=Extending_and_Customizing_JPPF#Job-aware_load_balancers">Job-aware load-balancer</a></li>
	<li><a href="http://www.jppf.org/wiki/index.php?title=Development_guide#Execution_policy">Execution policies</a></li>
	<li><a href="http://www.jppf.org/wiki/index.php?title=Development_guide#Job_Metadata">Job metadata</a></li>
</ul>
