...
<div align="justify">
					...
					<ul>
						<li><a href="src/org/jppf/example/ftp/service/FTPServerStartup.java.html">FTPServerStartup.java</a> : This is a <a href="/wiki/index.php?title=JPPF_startup_classes#Server_startup_classes">JPPF driver startup class</a>, which starts an Apache Mina FTPd server instance at driver startup time</li>
