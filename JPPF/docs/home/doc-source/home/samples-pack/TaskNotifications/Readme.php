...
$template{name="samples-page-header" title="Task Notifications sample"}$
...
<ul>
	<li>A <a href="http://www.jppf.org/wiki/index.php?title=Extending_and_Customizing_JPPF#Writing_a_custom_node_MBean"/>custom node MBean</a> that will send notifications to local or remote listeners using the JMX APIs.</li>
	<li>A simple facade to the MBean, deployed as a <a href="http://www.jppf.org/wiki/index.php?title=Extending_and_Customizing_JPPF#Node_startup_classes">JPPF node startup class</a>,
...
<ul>
	<li>package <b>org.jppf.example.tasknotifications.mbean</b>:<br/><br/>
	...
	&nbsp;</li>
	<li>package <b>org.jppf.example.tasknotifications.startup</b>:<br/><br/>
	...
	&nbsp;</li>
	<li>package <b>org.jppf.example.tasknotifications.test</b>:<br/><br/>
	...
	&nbsp;</li>
	<li>folder <b>META-INF/services</b>:<br/><br/>
...
<ol>
	<li>open a command prompt in JPPF-x.y.z-samples-pack/CustomMBeans</li>
...
<a href="http://www.jppf.org/wiki/index.php?title=Extending_and_Customizing_JPPF#Writing_a_custom_node_MBean"/>Pluggable management beans for JPPF nodes</a><br>
<a href="http://www.jppf.org/wiki/index.php?title=Extending_and_Customizing_JPPF#Node_startup_classes">Node startup classes</a><br>
<a href="http://www.jppf.org/wiki/index.php?title=Management_and_monitoring#Subscribing_to_MBean_notifications">Subscribing to notifications from a node</a>
