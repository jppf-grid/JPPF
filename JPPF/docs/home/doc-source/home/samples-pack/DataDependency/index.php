...
<p>A <a href="https://www.jppf.org/doc/6.1/index.php?title=JPPF_startup_classes#Node_startup_classes">node startup class</a> is also used to initialize the Hazelcast data structures in each node at startup time, and provides a convenient API for the tasks to access the distributed data.
...
See <a href="https://www.jppf.org/doc/6.1/index.php?title=Client_and_administration_console_configuration#Server_discovery">server discovery</a> and
<a href="https://www.jppf.org/doc/6.1/index.php?title=Client_and_administration_console_configuration#Manual_network_configuration">manual configuration</a> in the JPPF documentation for details on how to do this.
...
<ul>
  ...
  <li>Use of a <a href="https://www.jppf.org/doc/6.1/index.php?title=JPPF_startup_classes#Node_startup_classes">node startup class</a> to facilitate the integration</li>
  <li><a href="https://www.jppf.org/doc/6.1/index.php?title=Job_Service_Level_Agreement#Execution_policy">Execution policy</a> (to specify on which nodes the trades are computed)</li>
  <li><a href="https://www.jppf.org/doc/6.1/index.php?title=Dealing_with_jobs#Non-blocking_jobs">Asynchronous job submissions</a></li>
  <li>Extension of the <a href="https://www.jppf.org/doc/6.1/index.php?title=The_JPPF_configuration_API">JPPF configuration</a> to application-specific parameters</li>
</ul>
