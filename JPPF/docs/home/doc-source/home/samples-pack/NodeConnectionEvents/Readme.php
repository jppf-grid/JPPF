...
<div align="justify">
					...
					<ul class="samplesList">
						<li>Pluggable <a href="http://www.jppf.org/doc/v3/index.php?title=JPPF_startup_classes">startup classes</a> for JPPF nodes and servers</li>
						<li>Dynamic code deployment from the server to a node</li>
						<li><a href="http://www.jppf.org/doc/v3/index.php?title=Receiving_node_connection_events_in_the_server">Receiving node connection events in the server</a></li>
					</ul>
