...
<ul class="samplesList">
  ...
  <li>then start a JPPF server and at least one node. For information on how to set up a node and server, please refer to the <a href="https://www.jppf.org/doc/6.1/index.php?title=Introduction">JPPF documentation</a>.</li>
...
<ul class="samplesList">
  ...
  <li><a href="src/org/jppf/example/job/dependencies/DependencyProcessor.java.html">DependencyProcessor.java<a/>: deployed as a <a href="https://www.jppf.org/doc/6.1/index.php?title=JPPF_startup_classes#Server_startup_classes">server startup class</a>,
