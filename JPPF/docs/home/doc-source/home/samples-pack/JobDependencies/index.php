...
<ul class="samplesList">
  ...
  <li><a href="src/org/jppf/example/job/dependencies/DependencyDescriptor.java.html">DependencyDescriptor.java</a>: represents information of a job and its dependencies, parsed from the dependency graph definition file</li>
  <li><a href="src/org/jppf/example/job/dependencies/MyTask.java.html">MyTask.java</a>: a very simple JPPF task implementation, an instance of which is added to each job in the dependency graph</li>
  <li><a href="src/org/jppf/example/job/dependencies/Utils.java.html">Utils.java</a>: utility methods to print messages and parse the graph definition file</li>
</ul>
