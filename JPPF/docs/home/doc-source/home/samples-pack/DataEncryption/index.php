...
<ul class="samplesList">
  <li><a href="target/tohtml/src/org/jppf/example/dataencryption/CryptoSerialization.java.html">CryptoSerialization.java</a>: the data transformer that performs the encryption and decryption</li>
  <li><a href="target/tohtml/src/org/jppf/example/dataencryption/helper/Helper.java.html">Helper.java</a>: a set of utility methods to generate and retrieve passwords and secret keys, create and manipulate a keystore, and provide the encryption parameters</li>
</ul>
