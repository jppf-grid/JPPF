...
<p>For this, we will reuse the code and artifacts of the <a href="../Fractals">Fractals</a> sample, since it already implements JPPF tasks for the Mandelbrot computations,
