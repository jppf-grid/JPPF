...
$template{name="samples-page-header" title="JPPF Samples Pack"}$

<div class="blockWithHighlightedTitle" style="padding-left: 5px; padding-right: 5px; vertical-align: middle">
  ...
  <ul class="samplesList">
    ...
    <li><a href="AndroidDemo/Readme.php">Packaging tasks for execution on an Android device</a></li>
  </ul>
</div>
<br>
