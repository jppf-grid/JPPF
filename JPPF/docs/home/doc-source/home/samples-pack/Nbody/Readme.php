...
<div align="justify">
					...
					<p>Here's a screenshot of the simulation in action:<br/>
					<div align="center"><img src="images/Nbody.gif" border="0"></div>
...
<pre style="background-color: #C0C0C0; font-size: 0.9em;">
