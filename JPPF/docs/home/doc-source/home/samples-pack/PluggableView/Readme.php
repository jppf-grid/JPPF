...
<span style="color: green"># the position at which the custom view is inserted withing the enclosing tabbed pane</span>
...
<span style="color: green"># whether to autoamtically select th view; defaults to false</span>
