...
execMode = GPU</pre>
					...
					<ul class="samplesList">
						...
						<li><a href="src/org/jppf/example/aparapi/GeneratedOpenCL.c">GeneratedOpenCL.c</a>: the OpenCL code fgenrated from MatrixKernel which will be actuallyexecuted on the GPU</li>
