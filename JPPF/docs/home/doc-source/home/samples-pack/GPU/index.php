$template{name="sample-readme-html-header" title="GPU computation demo"}$
...
The tasks contain APARAPI-conformant code, whose bytecode is introspected at runtime to generate OpenCL code (see example <a href="target/tohtml/src/org/jppf/example/aparapi/GeneratedOpenCL.c.html">here</a>).
...
<ul class="samplesList">
  <li><a href="target/tohtml/src/org/jppf/example/aparapi/MatrixKernel.java.html">MatrixKernel.java</a>: this is the class that will be translated into OpenCL code</li>
  <li><a href="target/tohtml/src/org/jppf/example/aparapi/GeneratedOpenCL.c.html ">GeneratedOpenCL.c</a>: the OpenCL code generated from MatrixKernel which will be actually executed on the GPU</li>
  <li><a href="target/tohtml/src/org/jppf/example/aparapi/AparapiTask.java.html">AparapiTask.java</a>: the JPPF task which invokes the GPU bindings API</li>
  <li><a href="target/tohtml/src/org/jppf/example/aparapi/AparapiRunner.java.html">AparapiRunner.java</a>: the JPPF client application which submits the jobs to the grid</li>
  <li><a href="target/tohtml/src/org/jppf/example/aparapi/SquareMatrix.java.html">SquareMatrix.java</a>: a simple representation of a square dense matrix,
