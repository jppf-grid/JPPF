...
<ul class="samplesList">
  <li><a href="target/tohtml/src/org/jppf/example/nodelifecycle/node/NodeListener.java.html">NodeListener.java</a> : A listener to the node's life cycle events,
  provides transaction management for the JPPF tasks</li>
  <li><a href="target/tohtml/src/org/jppf/example/nodelifecycle/client/DBTask.java.html">DBTask.java</a> : this is the code for the tasks.
  ...
  <li><a href="target/tohtml/src/org/jppf/example/nodelifecycle/client/DBRunner.java.html">DBRunner.java</a> : this is the code for the client application.
  ...
  <li><a href="target/tohtml/config/jppf-client.properties.html">jppf-client.properties</a> : the jppf configuration files, which also allows you to modify some parameters of the sample application</li>
</ul>
