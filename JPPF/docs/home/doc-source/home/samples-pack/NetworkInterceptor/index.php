...
<ul class="samplesList">
  <li><a href="target/tohtml/src/org/jppf/example/interceptor/NetworkInterceptorDemo.java.html">NetworkInterceptorDemo.java</a>: The entry point for the demo</li>
  <li><a href="target/tohtml/src/org/jppf/example/interceptor/JaasNetworkInterceptor.java.html">JaasNetworkInterceptor.java</a>: the network interceptor implementation</li>
  <li><a href="target/tohtml/src/org/jppf/example/interceptor/CryptoHelper.java.html">CryptoHelper.java</a>: utility class used to create secret keys and encrypt/decrypt data</li>
  <li><a href="target/tohtml/src/org/jppf/example/interceptor/MyTask.java.html">MyTask.java</a>: a simple JPPF task added to the job submitted by the demo</li>
  <li><a href="target/tohtml/src/org/jppf/example/interceptor/auth/InterceptorLoginModule.java.html">InterceptorLoginModule.java</a>:
  the Jaas login module invoked from the network interceptyor to authenticate</li>
  <li><a href="target/tohtml/src/org/jppf/example/interceptor/auth/InterceptorCallbackHandler.java.html">InterceptorCallbackHandler.java</a>:
  used by the Jaas login module to retrieve the socket connection through which authentication is performed</li>
  <li><a href="target/tohtml/src/org/jppf/example/interceptor/auth/JPPFJaasConfiguration.java.html">JPPFJaasConfiguration.java</a>:
  a Jaas configuration implementation which avoids using a jaas.config file</li>
  <li><a href="target/tohtml/src/org/jppf/example/interceptor/auth/SocketCallback.java.html">SocketCallback.java</a>: used to transport the socket connection back to the login module</li>
</ul>
