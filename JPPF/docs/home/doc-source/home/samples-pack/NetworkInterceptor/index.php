...
<ul class="samplesList">
  ...
  <li><a href="src/org/jppf/example/interceptor/JaasNetworkInterceptor.java.html">JaasNetworkInterceptor.java</a>: the network interceptor implementation</li>
  ...
  <li><a href="src/org/jppf/example/interceptor/auth/InterceptorLoginModule.java.html">InterceptorLoginModule.java</a>: the Jaas login module invoked from the network interceptyor to authenticate</li>
  <li><a href="src/org/jppf/example/interceptor/auth/InterceptorCallbackHandler.java.html">InterceptorCallbackHandler.java</a>: used by the Jaas login module to retrieve the socket connection through which authentication is performed</li>
  <li><a href="src/org/jppf/example/interceptor/auth/JPPFJaasConfiguration.java.html">JPPFJaasConfiguration.java</a>: a Jaas configuration implementation which avoids using a jaas.config file</li>
  <li><a href="src/org/jppf/example/interceptor/auth/SocketCallback.java.html">SocketCallback.java</a>: used to transport the socket connection back to the login module</li>
</ul>
