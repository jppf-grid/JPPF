...
<p>This sample demonstrates the use of a <a href="https://www.jppf.org/doc/6.1/index.php?title=Network_interceptors">Network interceptor</a> in a very simple authentication scheme.
...
<ol class="samplesList">
  ...
  <li>You will then need to have a JPPF server and at least one node installed. For information on how to set up a node and server, please refer to the <a href="https://www.jppf.org/doc/6.1/index.php?title=Introduction">JPPF documentation</a></li>
