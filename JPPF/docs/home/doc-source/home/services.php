...
$template{name="about-page-header" title="Services"}$
  <h1 align="center">JPPF Services</h1>
  <div align="justify">
    $template{name="title-with-icon" img="images/icons/personal2.png" title="Community Support" heading="h3"}$
    ...
    $template{name="title-with-icon" img="images/icons/money.png" title="Commercial Services" heading="h3"}$
