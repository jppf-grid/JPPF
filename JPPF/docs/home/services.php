...
<td style="width: 1px"></td>
  ...
  <div align="justify">
    ...
    <h3 style="${style}"><img src="images/icons/personal2.png" class="titleWithIcon"/>Community Support</h3>
    ...
    <br><br><br>
    <div class="blockWithHighlightedTitle" style="vertical-align: middle">
    <h3 style="${style}"><img src="images/icons/money.png" class="titleWithIcon"/>Commercial Services</h3>
