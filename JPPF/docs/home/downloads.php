...
<td style="width: 1px"></td>
  ...
  <br>
  <table width="100%"><tr>
    <td style="width: 435px; padding-right: 5px">
  ...
  <h1 style="margin: 10px 0px">&nbsp;<img src="images/icons/download.png" class="titleWithIcon"/>JPPF <?php echo $ver1 ?></h1>
    ...
    <td style="width: 435px; padding-left: 5px">
      <div class="blockWithHighlightedTitle">
        <?php
          $tag1 = "v_6_1_4";
          $ver1 = "6.1.4";
  ...
  <div class="blockWithHighlightedTitle" style="vertical-align: middle">
    <div style="margin: 10px 5px">
      <img src="images/icons/folder-download.png" width="20"/>
      <h4 style="display: inline">Latest unstable version <a href="downloads-unstable.php">JPPF v6.3-alpha</a></h4>
    </div>
  </div>
  <br>
</div>
