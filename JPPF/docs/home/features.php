...
<td style="width: 1px"></td>
        ...
        <?php if ($currentPage == "v6.1") $itemClass = 'aboutMenuItem'; else $itemClass = 'aboutMenuItem2'; ?><div class="<?php echo $itemClass; ?>">&nbsp;&nbsp;&nbsp;<a href="/doc/6.1" class="<?php echo $itemClass; ?>">v6.1 (alpha)</a><br></div>
        ...
        <?php if ($currentPage == "${v}") $itemClass = 'aboutMenuItem'; else $itemClass = 'aboutMenuItem2'; ?><div class="<?php echo $itemClass; ?>">&nbsp;&nbsp;&nbsp;<a href="/tracker/tbg/jppf/issues/find/saved_search/1/search/1" class="<?php echo $itemClass; ?>">bugs</a><br></div>
        <?php if ($currentPage == "${v}") $itemClass = 'aboutMenuItem'; else $itemClass = 'aboutMenuItem2'; ?><div class="<?php echo $itemClass; ?>">&nbsp;&nbsp;&nbsp;<a href="/tracker/tbg/jppf/issues/find/saved_search/9/search/1" class="<?php echo $itemClass; ?>">features</a><br></div>
        <?php if ($currentPage == "${v}") $itemClass = 'aboutMenuItem'; else $itemClass = 'aboutMenuItem2'; ?><div class="<?php echo $itemClass; ?>">&nbsp;&nbsp;&nbsp;<a href="/tracker/tbg/jppf/issues/find/saved_search/2/search/1" class="<?php echo $itemClass; ?>">enhancements</a><br></div>
        <?php if ($currentPage == "${v}") $itemClass = 'aboutMenuItem'; else $itemClass = 'aboutMenuItem2'; ?><div class="<?php echo $itemClass; ?>">&nbsp;&nbsp;&nbsp;<a href="/tracker/tbg/jppf/issues/find/saved_search/8/search/1" class="<?php echo $itemClass; ?>">next version</a><br></div>
        <?php if ($currentPage == "${v}") $itemClass = 'aboutMenuItem'; else $itemClass = 'aboutMenuItem2'; ?><div class="<?php echo $itemClass; ?>">&nbsp;&nbsp;&nbsp;<a href="/tracker/tbg/jppf/issues/find/saved_search/22/search/1" class="<?php echo $itemClass; ?>">maintenance</a><br></div>
        <hr/>
  ...
  <div class="column_left" style="text-align: justify">
    ...
    <a name="feat01"></a>
    <h4 style="${style}"><img src="images/icons/easy.png" class="titleWithIcon"/>Ease of use</h4>
    ...
    <a name="feat02"></a>
    <h4 style="${style}"><img src="images/icons/topology.png" class="titleWithIcon"/>Dynamic flexible topology</h4>
    ...
    <br><div class="blockWithHighlightedTitle">
    <a name="feat03"></a>
    <h4 style="${style}"><img src="images/icons/preferences-desktop-4.png" class="titleWithIcon"/>Fault tolerance, self-repair and recovery</h4>
    ...
    <br><div class="blockWithHighlightedTitle">
    <a name="feat04"></a>
    <h4 style="${style}"><img src="images/icons/job-node2.png" class="titleWithIcon"/>Matching the Workload with the Grid</h4>
    ...
    <br><div class="blockWithHighlightedTitle">
    <a name="feat05"></a>
    <h4 style="${style}"><img src="images/icons/no-deployment.png" class="titleWithIcon"/>No deployment</h4>
  ...
  <div class="column_right" style="text-align: justify">
    <div class="blockWithHighlightedTitle">
    <a name="feat06"></a>
    <h4 style="${style}"><img src="images/icons/security.png" class="titleWithIcon"/>Security</h4>
    ...
    <br><div class="blockWithHighlightedTitle">
    <a name="feat07"></a>
    <h4 style="${style}"><img src="images/icons/monitoring.png" class="titleWithIcon"/>Administration and monitoring</h4>
    <p>The JPPF graphical <a href="/screenshots/gallery-images/Admin%20Console%20-%20Desktop/Topology-TreeView.gif">administration console</a>, along with the public <a href="https://www.jppf.org/doc/<?php echo $jppf_version; ?>/index.php?title=Management_and_monitoring">API</a> it is based on,
    ...
    servers and nodes <a href="/screenshots/gallery-images/Admin%20Console%20-%20Desktop/RuntimeMonitoring.gif">health</a>, <a href="/screenshots/gallery-images/Admin%20Console%20-%20Desktop/LoadBalancerSettings.gif">load-balancing</a> configuration,
    server <a href="/screenshots/gallery-images/Admin%20Console%20-%20Desktop/ServerStats-01.gif">statistics</a>, and a lot more.
    ...
    <br><div class="blockWithHighlightedTitle">
    <a name="feat08"></a>
    <h4 style="${style}"><img src="images/icons/load-balancing.png" class="titleWithIcon"/>Load balancing</h4>
    ...
    <br><div class="blockWithHighlightedTitle">
    <a name="feat09"></a>
    <h4 style="${style}"><img src="images/icons/integration.png" class="titleWithIcon"/>Android, .Net and J2EE integration</h4>
    <p>
    Specialized client and node implementations bring JPPF grids to the <a href="/doc/<?php echo $jppf_version; ?>/index.php?title=Android_Node">Android</a>, <a href="/doc/<?php echo $jppf_version; ?>/index.php?title=.Net_Bridge">.Net</a> and <a href="/doc/<?php echo $jppf_version; ?>/index.php?title=J2EE_Connector">J2EE</a> worlds.
    ...
    <br><div class="blockWithHighlightedTitle">
    <a name="feat10"></a>
    <h4 style="${style}"><img src="images/icons/personal.png" class="titleWithIcon"/>Customization</h4>
    <p>Whenever your specialized needs go beyond what is available out-of-the-box, JPPF provides many <a href="/doc/<?php echo $jppf_version; ?>/index.php?title=Extending_and_Customizing_JPPF">extension points, addons and plugins</a> which allow you to tailor, extend and customize the behavior of any of its components.
