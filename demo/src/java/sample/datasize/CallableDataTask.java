 ...
 */
public class CallableDataTask implements Callable<String>, Serializable
{
	/**
	 ...
	 */
	public CallableDataTask(int datasize)
	{
	 ...
	 */
	public CallableDataTask(int datasize, boolean inNodeOnly)
	{
		this.datasize = datasize;
