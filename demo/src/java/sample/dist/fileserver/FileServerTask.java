 ...
 */
public class FileServerTask extends JPPFTask
{
	/**
	 ...
	 */
	public FileServerTask(String inFile, String outFile)
	{
		this.inFile = inFile;
	...
	/**
	 * Download the file from the driver a store it in the out location.
	...
	public void run()
	{
		try
		{
			...
			FileClient client = FileServerFactory.createFileClient(
				"org.jppf.fileserver.ftp.FtpFileClient", (Properties) getDataProvider().getValue("ftp.config"));
			client.open();
