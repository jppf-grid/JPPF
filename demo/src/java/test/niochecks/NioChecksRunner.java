...
public class NioChecksRunner
{
   ...
   * @param name the name given to the job.
	 ...
	 */
	public JPPFJob createJob(String name) throws Exception
	{
	 ...
	 */
	public void executeJob(JPPFJob job) throws Exception
	{
   ...
   */
  public void displayResults(JPPFJob job) throws Exception
  {
    ...
    for (JPPFTask task: results)
    {
      if (task.getException() != null)
      {
        ...
        System.out.println(StringUtils.getStackTrace(task.getException()));
      }
      else
      {
