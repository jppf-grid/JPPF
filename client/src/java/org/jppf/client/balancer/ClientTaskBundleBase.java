 ...
 * @author Martin JANDA
 */
public abstract class ClientTaskBundleBase implements Serializable, Comparable<ClientTaskBundle>, JPPFDistributedJob
{
  /**
   ...
   */
  protected ClientTaskBundleBase(final JPPFJob job)
  {
    this.job = job;
   ...
   */
  public void setTasks(final List<JPPFTask> tasks)
  {
    this.tasks = tasks;
  }
   ...
   */
  @Override
  public int compareTo(final ClientTaskBundle bundle)
  {
