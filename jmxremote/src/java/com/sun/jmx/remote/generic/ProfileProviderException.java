...
/**
 * Exception thrown by {@code ProfileClientFactory} and {@code ProfileServerFactory} when a provider exists for the required profile name but cannot be used for some reason.
 */
public class ProfileProviderException extends Exception {
  ...
  /**
   * Constructs a <code>ProfileProviderException</code> with the specified detail message.
  ...
  /**
   * Constructs a <code>ProfileProviderException</code> with the specified detail message and nested exception.
   * @param message the detail message
