...
public class CloseMessage implements Message {
  ...
  /**
   * @serial The message explaining why the connection was closed.
   * @see #getMessage()
   */
   ...
   * @param msg a user specific message explaining why the connection was closed by the remote side
   */
  public CloseMessage(final String msg) {
    this.msg = msg;
  }

  /**
   * Returns a message explaining why the connection was closed by the remote side.
   * @return a message explaining why the connection was closed by the remote side.
   */
