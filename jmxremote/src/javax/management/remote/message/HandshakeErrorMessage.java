 ...
 */
/*
 * @(#)file      HandshakeErrorMessage.java
 ...
 * <p>At any time during the handshake, if either the client or the server encounters a problem they can notify the other peer by sending this indication message as to why the operation failed.
...
public class HandshakeErrorMessage implements Message {
   ...
   * @param detail a textual description of the error encountered by the peer object.
   */
  public HandshakeErrorMessage(final String detail) {
    this.detail = detail;
  }
