...
public class ClientListenerInfo extends ListenerInfo {
   ...
   * @return .
   */
  public boolean sameAs(final ObjectName name, final NotificationListener listener, final NotificationFilter filter, final Object handback) {
   ...
   * @return .
   */
  public boolean sameAs(final ObjectName name) {
