 ...
 */
public class TestDefaultDatabasePersistenceCacheableAsync extends AbstractJobPersistenceTest {
  /**
  ...
  public static void setup() throws Exception {
    ...
    config.driver.jppf = "classes/tests/config/" + prefix + "/driver_cacheable_async_db.properties";
