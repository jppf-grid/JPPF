...
public class TestSerialization extends AbstractNonStandardSetup {
  /**
   * Test timeout.
   */
   ...
   */
  private boolean allowsNonSerializable = true;
  ...
  public static Collection<Object[]> data() {
    final String[] exts = { "", "LZ4 ", "ZLIB " };
    final Object[][] classes = {
      { DefaultJavaSerialization.class, false },
      { DefaultJPPFSerialization.class, true },
      { KryoSerialization.class, true },
      { XstreamSerialization.class, false }
    };
    final List<Object[]> params = new ArrayList<>();
    for (final Object[] array: classes) {
      final Class<?> c = (Class<?>) array[0];
      final boolean b = (Boolean) array[1];
      for (final String ext: exts) params.add(new Object[] { ext + c.getName(), b});
    }
    return params;
  }
