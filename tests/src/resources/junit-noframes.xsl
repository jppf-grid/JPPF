<?xml version="1.0"?>
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0" xmlns:lxslt="http://xml.apache.org/xslt" xmlns:string="xalan://java.lang.String">
    ...
    <html>
      <head>
        ...
        <style type="text/css">
          ...
          table.details tr td { background:#C5D0F0; }
          p {
            line-height:1.5em;
