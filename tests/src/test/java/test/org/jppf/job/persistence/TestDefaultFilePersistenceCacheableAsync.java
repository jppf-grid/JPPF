 ...
 */
public class TestDefaultFilePersistenceCacheableAsync extends AbstractJobPersistenceTest {
  /**
  ...
  public static void setup() throws Exception {
    ...
    config.driver.jppf = CONFIG_ROOT_DIR + prefix + "/driver_cacheable_async_file.properties";
