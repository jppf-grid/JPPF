...
public class TestMultiServerWithSSL extends AbstractNonStandardSetup {
  ...
  public static void setup() throws Exception {
    ...
    config.driver.log4j = CONFIG_ROOT_DIR + "ssl2_p2p/log4j-driver.template.properties";
    config.node.log4j = CONFIG_ROOT_DIR + "ssl2_p2p/log4j-node.template.properties";
    client = BaseTestHelper.executeWithTimeout(15_000L, () -> BaseSetup.setup(2, 2, true, false, config));
  }
