 ...
 */
public class TestClientAsyncFileLoadBalancerPersistence extends AbstractClientLoadBalancerPersistenceTest {
  /**
  ...
  public static void setup() throws Exception {
    ...
    config.clientConfig = CONFIG_ROOT_DIR + prefix + "/client_async_file.properties";
