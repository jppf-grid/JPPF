 ...
 */
public class TestDriverAsyncDatabaseLoadBalancerPersistence extends AbstractDriverLoadBalancerPersistenceTest {
  /**
  ...
  public static void setup() throws Exception {
    ...
    config.driver.jppf = CONFIG_ROOT_DIR + prefix + "/driver_async_db.properties";
