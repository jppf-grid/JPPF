 ...
 */
public class NodeMBeanProviderManager extends AbstractMBeanProviderManager<JPPFNodeMBeanProvider> {
  /**
   ...
   */
  public NodeMBeanProviderManager(final Class<JPPFNodeMBeanProvider> clazz, final ClassLoader cl, final Object server, final Object... createParams) throws Exception {
    super(clazz, cl, server, createParams);
  }

  @Override
  protected Object createMBeanImpl(final JPPFNodeMBeanProvider provider, final Object...params) throws Exception {
    return provider.createMBean((Node) params[0]);
  }
}
