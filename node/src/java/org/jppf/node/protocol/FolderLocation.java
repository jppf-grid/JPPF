 ...
 */
public class FolderLocation extends AbstractLocation<String>
{
  /**
   ...
   */
  public FolderLocation(final File file) throws IOException
  {
   ...
   */
  public FolderLocation(final String file)
  {
    super(file);
  }
