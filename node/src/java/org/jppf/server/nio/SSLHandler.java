...
public class SSLHandler
{
  ...
  /**
   * Instantiate this SSLHandler w<ith the specified sicket channel and SSL engine.
   * @param channel the socket channel from which data is read or to which data is written. 
   * @param sslEngine performs the SSL-related operations before sending data/after receiving data.
   * @throws IOException if any error occurs.
   */
  public SSLHandler(final ChannelWrapper<?> channel, final SSLEngine sslEngine) throws IOException
  {
  ...
  public void close() throws IOException
  {
    ...
    channel.close();
    if (traceEnabled) log.trace("SSLEngine & channel closed");
  }
