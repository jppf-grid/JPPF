 ...
 * <p> the {@link #size()} method is also overriden to provide results in constant time instant of O(n) in
 * the super class, since it used frequently when comparing current pool size with the max size.
