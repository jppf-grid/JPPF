...
class ErrorReporter<S> implements DiagnosticListener<S>
{
   ...
   */
  private List<Diagnostic<? extends S>> errors = new ArrayList<Diagnostic<? extends S>>();
  /**
   * The list of warnings generated by the compilation.
   */
  private List<Diagnostic<? extends S>> warnings = new ArrayList<Diagnostic<? extends S>>();
  ...
  {
    return new ArrayList<Diagnostic<? extends S>>(errors);
  }
  ...
  {
    return new ArrayList<Diagnostic<? extends S>>(warnings);
  }
