...
public class SaveLink extends AjaxButtonWithIcon {
   ...
   */
  public SaveLink() {
    super(AdminConfigConstants.SAVE_ACTION, Model.of("Save"), "save.png");
  }
  ...
  public void onSubmit(final AjaxRequestTarget target, final Form<?> form) {
    ...
    JPPFWebConsoleApplication.get().getAdminData().setConfig(new TypedProperties().fromString(configString)).saveConfig();
  }
}
