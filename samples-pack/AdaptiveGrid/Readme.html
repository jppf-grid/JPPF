...
<p>The calculations for the number of client connections and the number of nodes are done as follows in a <a href="http://www.jppf.org/doc/5.2/index.php?title=Notifications_of_client_job_queue_events">client queue listener</a>:
<ul class="samplesList">
