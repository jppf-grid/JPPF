$template{name="sample-readme-html-header" title="Startup Classes demo"}$
...
<a href="http://www.jppf.org/doc/5.2/index.php?title=JPPF_startup_classes">JPPF startup classes</a> section.
