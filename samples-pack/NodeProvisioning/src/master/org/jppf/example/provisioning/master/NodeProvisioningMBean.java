 ...
 */
public interface NodeProvisioningMBean {
  /**
   * The object name of this MBean.
   */
  String MBEAN_NAME = "org.jppf.example.mbean:name=NodeProvisioning,type=node";
   ...
   */
  void provisionSlaveNodes(Integer nbNodes);
   ...
   */
  void provisionSlaveNodes(Integer nbNodes, TypedProperties configOverrides);
}
