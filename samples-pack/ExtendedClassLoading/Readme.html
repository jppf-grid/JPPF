...
<ul class="samplesList">
  ...
  <a href="http://www.jppf.org/doc/5.2/index.php?title=Job_Metadata">job metadata</a></li>
</ul>
...
The node behavior is driven by a <a href="http://www.jppf.org/doc/5.2/index.php?title=Receiving_notifications_of_node_life_cycle_events">node life cycle listener</a>:
<ul class="samplesList">
  ...
  <ol class="samplesList">
    ...
    This is a repository maintenance operation, which we recommend to perform via a <a href="http://www.jppf.org/doc/5.2/index.php?title=Job_Service_Level_Agreement#Broadcast_jobs">broadcast job</a></li>
...
<ul class="samplesList">
  <li><a href="http://www.jppf.org/doc/5.2/index.php?title=Class_loading_in_JPPF#JPPF_class_loading_extensions">Class loading extensions</a></li>
  <li><a href="http://www.jppf.org/doc/5.2/index.php?title=Receiving_notifications_of_node_life_cycle_events">Receiving notifications of node life cycle events</a></li>
