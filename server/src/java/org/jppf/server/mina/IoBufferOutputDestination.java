 ...
 */
public class IoBufferOutputDestination implements OutputDestination
{
	/**
	 ...
	 */
	public IoBufferOutputDestination(int size)
	{
		this(IoBuffer.allocate(size));
	}
	 ...
	 */
	public IoBufferOutputDestination(byte[] buffer, int offset, int len)
	{
		this(IoBuffer.wrap(buffer, offset, len));
	}
	 ...
	 */
	public IoBufferOutputDestination(IoBuffer buffer)
	{
		this.data = buffer;
	}
