 ...
 */
public class IoBufferInputSource implements InputSource
{
	/**
	 ...
	 */
	public IoBufferInputSource(byte[] data, int offset, int len)
	{
		this(IoBuffer.wrap(data, offset, len));
	}
	 ...
	 * @param data the buffer from which to read.
	 */
	public IoBufferInputSource(IoBuffer data)
	{
		this.data = data;
	}
