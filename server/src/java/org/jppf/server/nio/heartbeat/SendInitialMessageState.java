...
/**
 * In this state, the server is sending a handshake message to the node, passing the heartbeat parameters in the message.
 * @author Laurent Cohen
 */
class SendInitialMessageState extends HeartbeatServerState {
  /**
