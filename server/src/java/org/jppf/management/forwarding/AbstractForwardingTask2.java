 ...
 */
abstract class AbstractForwardingTask2 implements Callable<Pair<String, Object>> {
  /**
   ...
   */
  AbstractForwardingTask2(final AbstractNodeContext context, final String mbeanName, final String memberName) {
