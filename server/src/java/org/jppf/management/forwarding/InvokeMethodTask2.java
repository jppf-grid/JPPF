 ...
 */
class InvokeMethodTask2 extends AbstractForwardingTask2 {
  /**
   * Logger for this class.
   */
  private static final Logger log = LoggerFactory.getLogger(InvokeMethodTask2.class);
  /**
   ...
   */
  protected InvokeMethodTask2(final AbstractNodeContext context, final String mbeanName, final String methodName, final Object[] params, final String[] signature) {
  ...
  protected Pair<String, Object> execute() throws Exception {
    ...
    final Object o = wrapper.invoke(mbeanName, memberName, params, signature);
