 ...
 */
class GetAttributeTask2 extends AbstractForwardingTask2 {
  /**
   * Logger for this class.
   */
  private static final Logger log = LoggerFactory.getLogger(GetAttributeTask2.class);
  /**
   ...
   */
  protected GetAttributeTask2(final AbstractNodeContext context, final String mbeanName, final String attribute) {
